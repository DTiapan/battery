...
This directory contains Architecture Decision Records for the **Battery Context Engine**.

| ADR | Title | Status | Date |
| :--- | :--- | :--- | :--- |
| [0001](./0001-record-architecture-decisions.md) | Record Architecture Decisions | Accepted | 2026-09-11 |
| [0002](./0002-phased-runtime-stack.md) | Phased Implementation Stack (Python V1 Prototype to Go V2 Daemon) | Accepted | 2026-09-11 |
| [0003](./0003-storage-and-retrieval-engine.md) | Storage Substrate and Hybrid Retrieval Engine (SQLite WAL + FTS5 + Vector + RRF) | Accepted | 2026-09-11 |
